...
Peek records the call, it does not take part in it. This package hands the
client's view of a call over and nothing more: the request goes on as it
arrived, and so do the response and its bytes.
